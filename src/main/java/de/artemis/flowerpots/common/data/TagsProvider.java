...
public class TagsProvider {
    ...
    public static class BlockTagsProvider extends net.minecraft.data.tags.TagsProvider<Block> {
        ...
        protected void addTags() {
            ...
            tag(ModTags.Block.FLOWER_POT_NO_VARIANTS).add(ModBlocks.SMALL_FLOWER_POT_LARGE_FERN.get(), ModBlocks.SMALL_TALL_FLOWER_POT_LARGE_FERN.get(), ModBlocks.LARGE_FLOWER_POT_LARGE_FERN.get(), ModBlocks.LARGE_TALL_FLOWER_POT_LARGE_FERN.get(), ModBlocks.SMALL_HANGING_FLOWER_POT_IRON_CHAIN_LARGE_FERN.get(), ModBlocks.SMALL_HANGING_FLOWER_POT_GOLD_CHAIN_LARGE_FERN.get(), ModBlocks.SMALL_HANGING_FLOWER_POT_COPPER_CHAIN_LARGE_FERN.get(), ModBlocks.SMALL_FLOWER_POT_TALL_GRASS.get(), ModBlocks.SMALL_TALL_FLOWER_POT_TALL_GRASS.get(), ModBlocks.LARGE_FLOWER_POT_TALL_GRASS.get(), ModBlocks.LARGE_TALL_FLOWER_POT_TALL_GRASS.get(), ModBlocks.SMALL_HANGING_FLOWER_POT_IRON_CHAIN_TALL_GRASS.get(), ModBlocks.SMALL_HANGING_FLOWER_POT_GOLD_CHAIN_TALL_GRASS.get(), ModBlocks.SMALL_HANGING_FLOWER_POT_COPPER_CHAIN_TALL_GRASS.get());
        }
