...
public class TagsProvider {
    ...
    public static class BlockTagsProvider extends net.minecraft.data.tags.TagsProvider<Block> {
        ...
        @Override
        protected void addTags() {
            tag(ModTags.Block.EMPTY_FLOWER_POT).add(ModBlocks.SMALL_FLOWER_POT.get(), ModBlocks.TALL_FLOWER_POT.get());
            tag(ModTags.Block.UNFIRED_FLOWER_POT).add(ModBlocks.SMALL_UNFIRED_FLOWER_POT.get(), ModBlocks.TALL_UNFIRED_FLOWER_POT.get());
        }
